...
import type {
  ...
  VehicleReplacement,
  ReservationAgent,
} from '../../../src/apis/car-rental/reservations';
...
describe('Reservations API', () => {
    ...
    describe('listReservations', () => {
      ...
      it('should call client.get with correct URL with params', async () => {
        ...
        expect(mockClient.get).toHaveBeenCalledWith(
          '/car-rental/reservations?status=active&customer_id=cust-1',
        );
      });
  ...
  describe('Reservation Attempts', () => {
    describe('listReservationAttempts', () => {
      ...
      it('should call client.get with correct URL with params', async () => {
        ...
        expect(mockClient.get).toHaveBeenCalledWith(
          '/car-rental/reservation-attempts?status=failed&limit=10',
        );
      });
    });
    ...
    describe('findReservationAttemptsByEmail', () => {
      it('should call client.get with correct URL', async () => {
        ...
        expect(mockClient.get).toHaveBeenCalledWith(
          '/car-rental/reservation-attempts?email=test@example.com',
        );
        expect(result).toEqual(mockAttempts);
      });
    });
    ...
    describe('createReservationExtension', () => {
      it('should call client.post with correct URL and payload', async () => {
        ...
        expect(mockClient.post).toHaveBeenCalledWith(
          '/car-rental/reservations/res-1/extensions',
          payload,
        );
    ...
    describe('deleteReservationExtension', () => {
      it('should call client.delete with correct URL', async () => {
        ...
        expect(mockClient.delete).toHaveBeenCalledWith(
          '/car-rental/reservations/res-1/extensions/ext-1',
        );
      });
    });
  });
  ...
  describe('Payments', () => {
    ...
    describe('updateReservationPayment', () => {
      it('should call client.put with correct URL and payload', async () => {
        ...
        expect(mockClient.put).toHaveBeenCalledWith(
          '/car-rental/reservations/res-1/payments/pay-1',
          payload,
        );
      });
    });
    ...
    describe('chargeCustomerCard', () => {
      it('should call client.post with correct URL and payload', async () => {
        const payload = { amount: 75.0, description: 'Additional charges' };
        ...
        expect(mockClient.post).toHaveBeenCalledWith(
          '/car-rental/reservations/res-1/payments/charge',
          payload,
        );
  ...
  describe('Refunds', () => {
    ...
    describe('updateReservationRefund', () => {
      it('should call client.put with correct URL and payload', async () => {
        ...
        expect(mockClient.put).toHaveBeenCalledWith(
          '/car-rental/reservations/res-1/refunds/ref-1',
          payload,
        );
      });
    });
  ...
  describe('Vehicle Replacements', () => {
    ...
    describe('updateVehicleReplacement', () => {
      it('should call client.put with correct URL and payload', async () => {
        ...
        expect(mockClient.put).toHaveBeenCalledWith(
          '/car-rental/reservations/res-1/vehicle-replacements/repl-1',
          payload,
        );
      });
    });
  ...
  describe('Reservation Agents', () => {
    ...
    describe('assignPrimaryAgent', () => {
      it('should call client.post with correct URL and payload', async () => {
        ...
        expect(mockClient.post).toHaveBeenCalledWith(
          '/car-rental/reservations/res-1/agents/primary',
          { agent_id: 'agent-1' },
        );
      });
    });
    ...
    describe('assignReturnAgent', () => {
      it('should call client.post with correct URL and payload', async () => {
        ...
        expect(mockClient.post).toHaveBeenCalledWith(
          '/car-rental/reservations/res-1/agents/return',
          { agent_id: 'agent-2' },
        );
      });
    });
  ...
  describe('Booking Flow Functions', () => {
    ...
    describe('validateDatesAndGetClasses', () => {
      it('should call client.post with correct URL and payload', async () => {
        ...
        expect(mockClient.post).toHaveBeenCalledWith(
          '/car-rental/reservations/validate-dates',
          payload,
        );
    ...
    describe('updateVehicleClass', () => {
      it('should call client.put with correct URL and payload', async () => {
        ...
        expect(mockClient.put).toHaveBeenCalledWith(
          '/car-rental/reservations/res-1/vehicle-class',
          payload,
        );
        expect(result).toEqual(mockReservation);
      });
  ...
  describe('Rental Agreement and Signing', () => {
    describe('getRentalAgreement', () => {
      it('should call client.get with correct URL', async () => {
        ...
        expect(mockClient.get).toHaveBeenCalledWith(
          '/car-rental/reservations/res-1/rental-agreement',
        );
    ...
    describe('setSignDate', () => {
      it('should call client.post with correct URL and payload', async () => {
        ...
        expect(mockClient.post).toHaveBeenCalledWith(
          '/car-rental/reservations/res-1/sign-date',
          payload,
        );
      });
    });
    ...
    describe('uploadDriverSignature', () => {
      it('should call client.post with correct URL and signature string', async () => {
        ...
        expect(mockClient.post).toHaveBeenCalledWith('/car-rental/reservations/res-1/signature', {
          signature,
        });
  ...
  describe('Vehicle Management', () => {
    describe('assignVehicle', () => {
      it('should call client.post with correct URL and payload', async () => {
        ...
        expect(mockClient.post).toHaveBeenCalledWith(
          '/car-rental/reservations/res-1/assign-vehicle',
          payload,
        );
      });
    });
    ...
    describe('detachVehicle', () => {
      it('should call client.post with correct URL', async () => {
        ...
        expect(mockClient.post).toHaveBeenCalledWith(
          '/car-rental/reservations/res-1/detach-vehicle',
        );
      });
    });
    ...
    describe('getAvailableVehicles', () => {
      it('should call client.get with correct URL', async () => {
        ...
        expect(mockClient.get).toHaveBeenCalledWith(
          '/car-rental/reservations/res-1/available-vehicles',
        );
  ...
  describe('error handling', () => {
    it('should propagate errors from core reservation operations', async () => {
      ...
      await expect(reservationsAPI.listReservations()).rejects.toThrow(
        'Reservation operation failed',
      );
      await expect(reservationsAPI.findReservation('res-1')).rejects.toThrow(
        'Reservation operation failed',
      );
      await expect(reservationsAPI.createReservation({})).rejects.toThrow(
        'Reservation operation failed',
      );
      await expect(reservationsAPI.updateReservation('res-1', {})).rejects.toThrow(
        'Reservation operation failed',
      );
    });
    ...
    it('should propagate errors from status management operations', async () => {
      ...
      await expect(reservationsAPI.setReservationOpen('res-1')).rejects.toThrow(
        'Status update failed',
      );
      await expect(reservationsAPI.setReservationCancel('res-1')).rejects.toThrow(
        'Status update failed',
      );
      await expect(reservationsAPI.setReservationPending('res-1')).rejects.toThrow(
        'Status update failed',
      );
      await expect(reservationsAPI.setReservationQuote('res-1')).rejects.toThrow(
        'Status update failed',
      );
      await expect(reservationsAPI.setReservationNoShow('res-1')).rejects.toThrow(
        'Status update failed',
      );
    });
    ...
    it('should propagate errors from reservation attempts operations', async () => {
      ...
      await expect(reservationsAPI.listReservationAttempts()).rejects.toThrow(
        'Reservation attempts operation failed',
      );
      await expect(
        reservationsAPI.findReservationAttemptsByEmail('test@example.com'),
      ).rejects.toThrow('Reservation attempts operation failed');
    });
    ...
    it('should propagate errors from extensions operations', async () => {
      ...
      await expect(reservationsAPI.listReservationExtensions('res-1')).rejects.toThrow(
        'Extensions operation failed',
      );
      await expect(reservationsAPI.createReservationExtension('res-1', {})).rejects.toThrow(
        'Extensions operation failed',
      );
      await expect(reservationsAPI.deleteReservationExtension('res-1', 'ext-1')).rejects.toThrow(
        'Extensions operation failed',
      );
    });
    ...
    it('should propagate errors from external charges operations', async () => {
      ...
      await expect(reservationsAPI.listExternalCharges('res-1')).rejects.toThrow(
        'External charges operation failed',
      );
      await expect(reservationsAPI.createExternalCharge('res-1', {})).rejects.toThrow(
        'External charges operation failed',
      );
      await expect(reservationsAPI.deleteExternalCharge('res-1', 'charge-1')).rejects.toThrow(
        'External charges operation failed',
      );
    });
  });
